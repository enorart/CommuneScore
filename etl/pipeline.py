...
from etl.sources import airparif, bpe, idfm_gares, mos, rent, ssmsi
...
# columns appear in the output. ips_schools is still a stub; adding one here is
# all that is left once its module is written.
SOURCES = [rent, bpe, idfm_gares, ssmsi, airparif, mos]
